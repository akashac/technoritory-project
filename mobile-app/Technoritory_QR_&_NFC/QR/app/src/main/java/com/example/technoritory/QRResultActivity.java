...
public class QRResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //result = findViewById(R.id.qrcoderesult);
        ...
        new GetAllProductData().execute(new ApiConnector());


        ShowDetails showDetails = new ShowDetails();

        WebView webView = (WebView) findViewById(R.id.qrdisplayView);
    ...
    private class GetAllProductData extends AsyncTask<ApiConnector,Long,JSONArray> {
        ...
        protected JSONArray doInBackground(ApiConnector... params) {
            ...
            return params[0].getAllData(barcode);
        }
    ...
    class ShowDetails{
        ...
        public String returnData(){ return s; }

        @android.webkit.JavascriptInterface
        public void details(String data){

            //  details activity
            Intent intent = new Intent(QRResultActivity.this, ProductDetailsActivity.class);
        ...
        public void journey(String data){
            ...
            //  details activity
            Intent intent = new Intent(QRResultActivity.this, ProductJourneyActivity.class);
            intent.putExtra("details", data);
            startActivity(intent);
        }
