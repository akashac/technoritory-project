...
public class NFCScanActivity extends AppCompatActivity {
    ...
    public void onCreate(final Bundle savedState) {
        ...
        currentTagView = (TextView) findViewById(R.id.nfctext);
        ...
        if (nfcAdapter != null && nfcAdapter.isEnabled()){
            ...
            Intent intent = new Intent(NFCScanActivity.this, NotAvilableActivity.class);
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (rawMsgs != null) {
            ...
            Intent i = new Intent(NFCScanActivity.this, NFCResultActivity.class);
            i.putExtra("code", tagData);
            startActivity(i);
        }
